...
public class WordCombined3 extends Configured implements Tool {
...
/*                cnt += 1;
    ...
    public int run(String[] args) throws Exception {
        ...
        job1.setJarByClass(WordCombined3.class);
        job1.setJobName("Word Combined");

        FileInputFormat.setInputPaths(job1, new Path(args[1] + "/R2"));
        ...
        job2.setJarByClass(WordCombined3.class);
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new WordCombined3(), args);
